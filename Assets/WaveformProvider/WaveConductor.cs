...
namespace Es.WaveformProvider
{
    ...
    public class WaveConductor : MonoBehaviour
    {
        ...
        private void WaveUpdate()
        {
            ...
            WaveMaterial.SetFloat(ShaderPropertyC, c);
            ...
            //TODO:このPrevレンダリングテクスチャを取得できるAPIを作る。勝手にrendererのmaterialにセットしない。
            //あくまでこのスクリプトはwave用テクスチャを提供するだけの機能。ただし、InkPainterを使っているからいい感じの位置に波の入力が出来る。くらいのコンポーネント。
